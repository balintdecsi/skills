...
Free / openly licensed data sources commonly used in geospatial projects. When pulling data, **document the CRS, source URL, download date, and licence** next to the load call.
...
| Source | What | URL |
|---|---|---|
| Natural Earth | World admin / cultural / physical layers at 110m, 50m, 10m (e.g. `ne_110m_admin_0_countries`). Public domain. | <https://www.naturalearthdata.com/> |
...
| Vienna Open Data | `vienna_districts.geojson` and many city layers. CC BY 4.0. | <https://www.data.gv.at/> |
...
| Source | What | URL |
|---|---|---|
| GHSL (JRC Global Human Settlement Layer) | Population grids, built-up surface, settlement model, urban centres (e.g. `GHS_POP_E2030_GLOBE_R2023A_4326_30ss_V1_0.tif`). CC BY 4.0. | <https://ghsl.jrc.ec.europa.eu/datasets.php> |
...
| Source | What | URL |
|---|---|---|
| HydroSHEDS / HydroRIVERS | Global rivers, drainage basins, lakes. CC BY 4.0. | <https://www.hydrosheds.org/> |
