...
|---|---|---|
| [earino/ECBS5294](https://github.com/earino/ECBS5294) | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) for course materials — Copyright © 2026 Eduardo Ariño de la Rubia. Datasets under `data/` are excluded and keep their original licences (incl. CC BY-SA 4.0 and CC BY-NC-SA 4.0); none are redistributed here. | `data-warehousing` — licence named in the skill; no endorsement implied |
...
| [divenyijanos/ceu-ml](https://github.com/divenyijanos/ceu-ml) | None declared; author permission granted by email (September 2026) | `ml-modeling` (workflow discussion) |
